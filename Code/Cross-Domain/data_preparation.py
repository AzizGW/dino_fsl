...
class DomainDataset(Dataset):
    ...
    def _load_data_info(self):
        ...
        try:
            ...
            print(f"No labels.csv file found in {self.data_folder}. Skipping...")
...
def create_N_way_few_shot_dataset(dataset, k, N):
    ...
    unique_labels =range(len(dataset.label_list))
    ...
    def create_task_sets(classes_set):
        ...
        for idx, item_dict in enumerate(dataset.data_info):
            if dataset.label_list.index(item_dict['label']) in classes_set:
