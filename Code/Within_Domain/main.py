...
project_folder_path = '/path/to/Code'
...
results_filename = f"../Results/Within_Domain_experiment_results_{modelName}.txt"
...
with open(results_filename, "w") as file:
    for domain in domains_names:
        ...
        domain_results = startExperiment(DomainDataset(domain_path, transform), modelName, domain, embedding_dim, N, num_tasks, num_epochs)
